...
\begin{frame}
	...
	\begin{definition}
		\structure{Command} is something that can be identified by Latex and represents a certian function in output file, or in relation with some specific character or format
	\end{definition}
...
\begin{frame}
	...
	There are some defined color \structure{name} in the \structure{xcolor} package, such as black, pink, blue, red, green, brown, yellow, white and etc. You can find more information in the documentation of \structure{xcolor} (\alert{texdoc} \structure{xcolor})
\end{frame}
...
\begin{frame}
    ...
    \\ if we only want to type one character as the subscript or superscript \{\} can be omitted.
\end{frame}

\section{Use Tables and Graphics in \LaTeX}
\begin{frame}
	\tableofcontents[currentsection,hideothersubsections]
\end{frame}

\subsection{Draw a simple tabular}
\begin{frame}
	\frametitle{Draw a simple tabular}
    \begin{example}
        \begin{tabular}{|l|c|r|}
        \hline
...
\subsection{Draw tabular of various structure}

\begin{frame}
   \frametitle{Draw tabular of various structure}
   \begin{example}
   \begin{tabular}{|c|c|c|}
   \hline
   \multicolumn{2}{|c|}{multicolumn} & *\\
   \hline 
   \multirow{2}{1.5cm}{row} & * & *\\
   \cline{2-3}
   \multirow{2}{1.5cm}{} & * & *\\
   \hline
   \end{tabular}
   ...
   {\color{red} $\backslash$begin\{tabular\}\{\textvertline c\textvertline c\textvertline c\textvertline \}\\
   $\backslash$hline\\
   $\backslash$multicolumn\{2\}\{\textvertline c\textvertline\}\{multicolumn\} \& * $\backslash\backslash$\\
   $\backslash$hline \\
   $\backslash$multirow\{2\}\{1.5cm\}\{row\} \& * \& *$\backslash\backslash$\\
   $\backslash$cline\{2$-$3\}\\
   $\backslash$multirow\{2\}\{1.5cm\}\{\} \& * \& *$\backslash\backslash$\\
   $\backslash$hline\\
   $\backslash$end\{tabular\}\\}
\end{frame}

\begin{frame}
   $\backslash$multirow\{the number of boxes this multicloumn will occupy\}\{the width of the box(..cm)\}\{contents\} \\
   $\backslash$multicolumn\{the number of boxes this multicloumn will occupy\}\{\textvertline l/c/r\textvertline \}\{contents\} \\
   $\backslash$cline\{the column number of the beginning of the line $-$ the column number of the end of the line\} \\
\end{frame}
...
\begin{frame}
    ...
    A {\color{blue}table} enviornment is used to arrange the place of a tabular
       ...
       {\color{red} \qquad \textbackslash begin\{tabular(*)\}}\\ 
		\quad ...\\
       {\color{red} \qquad \textbackslash end\{tabular(*)\}}\\
    ...
    \\\text{[p]} means inserting the tabular to another new page.
    \\Besides, we can also insert command between {\color{red}\textbackslash begin\{table(*)\}[htbp]} and {\color{red} \qquad \textbackslash begin\{tabular(*)\}}, such as {\color{red} \textbackslash centering}, {\color{red} \textbackslash small} and etc, to arrange some special format of the tabular.
\end{frame}
\begin{frame}
