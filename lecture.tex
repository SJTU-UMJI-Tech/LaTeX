...
\begin{frame}
	...
	\begin{example}
		\begin{minipage}{0.3\linewidth}
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=0.8\linewidth,angle=90]{lena.jpg}
				\caption{Lena}
				\label{fig-lena}		
			\end{figure}			
		\end{minipage}
		\begin{minipage}{0.66\linewidth}
			...
			\phantom{\qquad}\samplecommand{includegraphics}[width=0.8\samplecommand{linewidth},\\
			angle=90]\{lena.jpg\}\\
			\phantom{\qquad}\samplecommand{caption}\{Lena\}\\
			\phantom{\qquad}\samplecommand{label}\{fig-lena\}\\
			\sampleend{figure}
		\end{minipage}
	\end{example}
\end{frame}
...
\begin{frame}
	...
	Sometimes you need to include a series of graphs, then the \structure{subfigure} package 
\end{frame}
