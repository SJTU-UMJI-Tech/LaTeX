...
\begin{frame}
	...
	The main body of your document starts with \LC{\begin{document}} and ends with \LC{\end{document}} the \structure{document} environment. All of the contents you'd like to display should be in it, and it \alert{MUST} be \alert{unique} in the whole file.
\end{frame}
...
\subsection{Introduction of some basic document classes}
