...
\begin{frame}[fragile]
	...
	\end{description}
	Some options can be added, like
...
\begin{frame}
	...
	\centering Read the source code of this project and you will learn much about it ...
\end{frame}
...
\begin{frame}[fragile]
	...
	It's very useful to generate a title on the first page of a document, in order to achieve it, these commands should first be added between \LC{\documentclass} and \LC{\begin{document}}.
	\begin{example}
		\begin{minted}{latex}
\title{title}
\author{author name}
...
\begin{frame}[fragile]
	...
	The main body of your document which starts with \LC{\begin{document}} and ends with \LC{\end{document}} is called the \structure{document} environment. All of the contents you'd like to display should be in it, and it \alert{MUST} be \alert{unique} in the whole file.
	\begin{example}
		\begin{minted}{latex}
\begin{document}
    \maketitle
...
\subparagraph*{name}
	...
	\end{multicols}
	\end{command}
	In document classes such as \structure{report} and \structure{book}, some outer structures of \structure{section} (\LC{\chapter} and \LC{\part}) can be used. \\
