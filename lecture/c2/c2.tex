...
\begin{frame}[fragile]
	...
	If you want to use a language with characters similar to English, package \structure{babel} can be used (exactly the same name as \href{http://babeljs.io/}{babel}).
	\begin{command}
