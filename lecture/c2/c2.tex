...
\begin{frame}
	...
	Sometimes you may want to deal with symbols you have never seen. In this case, you may refer to \myhref{http://detexify.kirelabs.org/classify.html} to find out how to output the character.
\end{frame}
